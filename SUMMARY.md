...
* [Log in to IBM Cloud Pak for Data](set-up/log-in-to-ibm-cloud-pak-for-data.md)
* [Register and log in to IBM Cloud](set-up/register-and-log-in-to-ibm-cloud.md)
...
* [Add speech input/output](speech-service/add-speech-input-output.md)
* [Language Translator](speech-service/language-translator.md)
* [Talk to a human \(integrations\)](speech-service/talk-to-a-human-integrations.md)
* [WAVI?](speech-service/wavi.md)
